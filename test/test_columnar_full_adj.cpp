// Full-schema COLUMNAR property storage tests for AdjList.
//
// Tests:
...
int main()
{
    ...
    opts.db_name         = "test_col_full_adj";
    opts.db_dir          = "./db_test/db_col_full_adj";
    ...
    fprintf(stderr, "\nAll full-schema COLUMNAR AdjList tests passed.\n");
    return 0;
}

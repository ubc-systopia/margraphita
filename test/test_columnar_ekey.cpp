// COLUMNAR property storage tests for SplitEdgeKey.
//
// Tests:
...
void test_columnar_post_props(GraphBase &g)
{
    ...
    SNBPostSchema::set_tag(buf2.data(), 1);
...
{
    INFO();
    // P0->P1 and P0->P2 edges (may already exist; add_edge is idempotent on dup key)
    add_edge(g, P0, P1);
    add_edge(g, P0, P2);
...
int main()
{
    ...
    fprintf(stderr, "\nAll COLUMNAR SplitEdgeKey tests passed.\n");
    return 0;
}

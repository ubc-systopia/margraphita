...
class UnOrderedEdgeListInCursor : public InCursor
{
   public:
    UnOrderedEdgeListInCursor(WT_CURSOR *cur, WT_SESSION *sess) : InCursor(cur, sess) {}
...
class UnOrderedEdgeListOutCursor : public OutCursor
{
   public:
    UnOrderedEdgeListOutCursor(WT_CURSOR *cur, WT_SESSION *sess)
        : OutCursor(cur, sess)
    {
    }
...
class UnOrderedEdgeListNodeCursor : public NodeCursor
{
   public:
    UnOrderedEdgeListNodeCursor(WT_CURSOR *cur, WT_SESSION *sess)
        : NodeCursor(cur, sess)
    {
    }
...
class UnOrderedEdgeListEdgeCursor : public EdgeCursor
{
   public:
    UnOrderedEdgeListEdgeCursor(WT_CURSOR *cur, WT_SESSION *sess)
        : EdgeCursor(cur, sess)
    {
    }

    UnOrderedEdgeListEdgeCursor(WT_CURSOR *cur,
                                WT_SESSION *sess,
                                bool get_weight)
